...
class _EditRoomDialogState extends ConsumerState<EditRoomDialog> {
  ...
  void initState() {
    ...
    _basePriceController.text = widget.room.basePricePerNight.toString();
    _peakPriceController.text = widget.room.peakSeasonPrice.toString();
    _capacityController.text = widget.room.capacity.toString();
    _descriptionController.text = widget.room.description;
    _amenitiesController.text = widget.room.amenities.join(', ');
    _specificationsController.text = widget.room.specifications['description'] ?? '';
