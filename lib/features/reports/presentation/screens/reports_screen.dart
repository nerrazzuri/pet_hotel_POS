          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                ...
                Tab(icon: Icon(Icons.trending_up, size: 20), text: 'Sales'),
                Tab(icon: Icon(Icons.hotel, size: 20), text: 'Bookings'),
              ...
              child: Column(
                children: [
                  _buildActionButton(
                    ...
                    subtitle: 'Download sales analytics and trends',
                    color: Colors.green,
                    onTap: () {
                  ...
                  _buildActionButton(
                    ...
                    subtitle: 'Download booking and occupancy data',
                    color: Colors.blue,
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  _buildActionButton(
                    ...
                    subtitle: 'Download stock and inventory data',
                    color: Colors.orange,
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  _buildActionButton(
                    ...
                    subtitle: 'Download customer analytics',
                    color: Colors.teal,
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  _buildActionButton(
                    ...
                    subtitle: 'Download comprehensive financial data',
                    color: Colors.purple,
                    onTap: () {
                      Navigator.pop(context);
