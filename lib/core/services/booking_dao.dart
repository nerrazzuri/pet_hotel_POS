...
class BookingDao {
  ...
  static void _initialize() {
    ...
    _bookings['booking_004'] = Booking(
      ...
      checkInTime: BookingTimeOfDay(hour: 10, minute: 0),
      checkOutTime: BookingTimeOfDay(hour: 11, minute: 0),
      status: BookingStatus.confirmed,
      type: BookingType.standard,
      ...
      updatedAt: DateTime.now(),
      depositAmount: 50.00,
      specialInstructions: 'Window view preferred',
      careNotes: 'Active cat, needs playtime',
      paymentMethod: 'card',
      paymentStatus: 'paid',
    );
    ...
    _bookings['booking_005'] = Booking(
      ...
      checkInDate: DateTime.now(),
      checkOutDate: DateTime.now().add(const Duration(days: 3)),
      checkInTime: BookingTimeOfDay(hour: 14, minute: 30),
      checkOutTime: BookingTimeOfDay(hour: 10, minute: 0),
      status: BookingStatus.confirmed,
      ...
      updatedAt: DateTime.now(),
      depositAmount: 100.00,
      specialInstructions: 'Deluxe room with extra space',
      careNotes: 'Friendly dog, loves attention',
      paymentMethod: 'cash',
      paymentStatus: 'partial',
    );

    _bookings['booking_006'] = Booking(
      id: 'booking_006',
      ...
      depositAmount: 0.00,
      specialInstructions: 'Quiet room preferred',
      careNotes: 'Shy cat, minimal handling',
      paymentMethod: 'card',
      paymentStatus: 'pending',
    );
